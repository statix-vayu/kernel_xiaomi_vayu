...
if ! [ -d "$TC_DIR" ]; then
    ...
    if ! git clone -q --depth=1 --single-branch https://android.googlesource.com/platform/prebuilts/clang/host/linux-x86 -b android-14.0.0_r54 $TC_DIR; then
...
completion()
{
    ...
    if [[ -f ${COMPILED_IMAGE} && ${COMPILED_DTBO} ]]; then
        ...
        git clone -q https://github.com/resist15/AnyKernel3 -b master $anykernel
